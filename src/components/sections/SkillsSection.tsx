...
const skillCategories: SkillCategory[] = [
  ...
  {
    name: 'Backend',
    skills: ['Python', 'Django', 'FastAPI', 'Node.js', 'PostgreSQL'],
  },
  {
    name: 'AI & Data',
    skills: ['Machine Learning', 'Scikit-learn', 'Pandas', 'NumPy', 'Data Analysis'],
  },
  {
    name: 'Tools & Practices',
    skills: ['Git', 'Docker', 'Agile/Scrum', 'CI/CD', 'REST APIs'],
  },
];
