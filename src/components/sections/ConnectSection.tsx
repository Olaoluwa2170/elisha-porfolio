...
const socialLinks = [
  {
    name: 'Email',
    href: 'mailto:elishadbabs@gmail.com',
    icon: Mail,
    label: 'elishadbabs@gmail.com',
  },
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/elishababalola',
    icon: Linkedin,
    label: '/in/elishababalola',
  },
  {
    name: 'GitHub',
    href: 'https://github.com/elishababalola',
    icon: Github,
    label: '@elishababalola',
  },
];
        ...
        <div className="max-w-4xl">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-12 max-w-2xl">
              Whether you're looking for a collaborator, have a project in mind, or just want to 
              chat about tech and finance — my inbox is always open.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.4}>
            <div className="pt-12 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Babalola Elisha. Crafted with passion.
              </p>
              <p className="text-sm text-muted-foreground">
